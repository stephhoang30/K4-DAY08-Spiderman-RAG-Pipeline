...
def generate_with_citation(query: str, top_k: int = TOP_K) -> dict:
    ...
    # Step 5: Call LLM. OPENROUTER_API_KEY (":free" models) ưu tiên vì miễn phí;
    # fallback OPENAI_API_KEY (base_url mặc định của OpenAI, model bỏ prefix "openai/")
    # theo đúng comment cảnh báo 429 rate-limit ở day8-lab-rag-pipeline.md.
    ...
    if openrouter_key:
        ...
        if not openai_key:
            raise RuntimeError("Cần OPENROUTER_API_KEY hoặc OPENAI_API_KEY trong .env")
